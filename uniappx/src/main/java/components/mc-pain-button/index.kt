...
open class GenComponentsMcPainButtonIndex : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenComponentsMcPainButtonIndex) -> Any? = fun(__props): Any? {
            ...
            val _ctx = __ins.proxy as GenComponentsMcPainButtonIndex
            ...
            val customStyle = computed(fun(): UTSJSONObject {
                ...
                if (props.color != "") {
                    ...
                    customStyle["color"] = globalData.theme.painFontColor
                }
                if (props.bgColor != "") {
                    customStyle["backgroundColor"] = props.bgColor
                } else {
                    customStyle["backgroundColor"] = globalData.theme.painColor
                }
            ...
            return fun(): Any? {
                ...
                , "onTouchend" to fun(){
                    ...
                    if (_ctx.iconPath != "") {
                        _cE("image", _uM("key" to 0, "style" to _nS(_uM("width" to _ctx.iconSize, "margin-right" to "10rpx")), "src" to _ctx.iconPath, "mode" to "widthFix"), null, 12, _uA(
                            "src"
                        ))
                    } else {
                        _cC("v-if", true)
