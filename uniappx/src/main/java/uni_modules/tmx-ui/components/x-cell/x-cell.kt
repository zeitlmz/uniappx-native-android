...
open class GenUniModulesTmxUiComponentsXCellXCell : VueComponent {
    ...
    override fun `$render`(): Any? {
        ...
        return _cE("view", _uM("onClick" to _ctx.clickLisent, "hover-start-time" to if (_ctx._isLinksHover) {
            50
        } else {
            0
        }
        ...
        , "class" to "xCell", "style" to _nS(_uM("backgroundColor" to _ctx._color, "borderRadius" to if (_ctx._allAttr.card == true) {
            _ctx._cardRadius
        } else {
            "0px"
        }
        ...
        , "borderBottom" to if (_ctx._allAttr.bottom && !_ctx._allAttr.card && !_ctx.bottomBorderInsert) {
            ...
            if (isTrue(_ctx._icon)) {
                _cE("view", _uM("key" to 0, "class" to "xCellAvatar", "style" to _nS(_uM("width" to _ctx._leftSize, "height" to _ctx._leftSize, "borderRadius" to _ctx._avatarRound))), _uA(
                    renderSlot(_ctx.`$slots`, "avatar", _uM("icon" to _ctx._icon), fun(): UTSArray<Any> {
                        return _uA(
                            _cV(_component_x_icon, _uM("color" to _ctx._allAttr.iconColor, "font-size" to _ctx._iconSize, "name" to _ctx._icon), null, 8, _uA(
                                "color",
                                "font-size",
                                "name"
                            ))
            ...
            ,
            _cE("view", _uM("class" to "xCellWrap", "style" to _nS(_uM("borderBottom" to if (_ctx._allAttr.bottom && !_ctx._allAttr.card && _ctx.bottomBorderInsert) {
                "1px solid " + _ctx._bottomBorderColor
            } else {
                "none"
            }
                ...
                _cE("view", _uM("class" to "center"), _uA(
                    renderSlot(_ctx.`$slots`, "default", UTSJSONObject(), fun(): UTSArray<Any> {
                        return _uA(
                            _cE("text", _uM("class" to "title", "style" to _nS(_uM("color" to _ctx._titleColor, "fontSize" to _ctx._titleSize))), _tD(_ctx._allAttr.title), 5)
                        )
                    }
                    ),
                    renderSlot(_ctx.`$slots`, "desc", _uM("desc" to _ctx._allAttr.desc), fun(): UTSArray<Any> {
                        return _uA(
                            if (_ctx._allAttr.desc != "") {
                                _cV(_component_x_text, _uM("key" to 0, "font-size" to "12", "color" to "#bfbfbf", "dark-color" to "#bfbfbf", "class" to "desc"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                    return _uA(
                                        _tD(_ctx._allAttr.desc)
                                    )
                                }), "_" to 1))
                            } else {
                                _cC("v-if", true)
    ...
    companion object {
        ...
        var props = _nP(_uM("icon" to _uM("type" to "String", "default" to ""), "avatarRound" to _uM("type" to "String", "default" to "8"), "color" to _uM("type" to "String", "default" to "white"), "darkColor" to _uM("type" to "String", "default" to ""), "iconColor" to _uM("type" to "String", "default" to ""), "title" to _uM("type" to "String", "default" to "标题"), "titleColor" to _uM("type" to "String", "default" to "black"), "darkTitleColor" to _uM("type" to "String", "default" to "white"), "titleSize" to _uM("type" to "String", "default" to "16"), "iconSize" to _uM("type" to "String", "default" to "24"), "label" to _uM("type" to "String", "default" to ""), "labelColor" to _uM("type" to "String", "default" to "#bfbfbf"), "labelSize" to _uM("type" to "String", "default" to "13"), "desc" to _uM("type" to "String", "default" to ""), "showBottomBorder" to _uM("type" to "Boolean", "default" to true), "bottomBorderInsert" to _uM("type" to "Boolean", "default" to false), "bottomBorderColor" to _uM("type" to "String", "default" to ""), "link" to _uM("type" to "Boolean", "default" to true), "linkColor" to _uM("type" to "String", "default" to "#bfbfbf"), "linkDarkColor" to _uM("type" to "String", "default" to "#bfbfbf"), "url" to _uM("type" to "String", "default" to ""), "card" to _uM("type" to "Boolean", "default" to true), "round" to _uM("type" to "String", "default" to ""), "leftSize" to _uM("type" to "String", "default" to "32"), "minHeight" to _uM("type" to "String", "default" to "55"), "disabled" to _uM("type" to "Boolean", "default" to false), "padding" to _uM("type" to "Array", "default" to fun(): UTSArray<String> {
            return _uA<String>("12", "0")
        }
        ), "margin" to _uM("type" to "Array", "default" to fun(): UTSArray<String> {
            return _uA<String>()
        }
        ), "rightWidth" to _uM("type" to "String", "default" to "100")))
