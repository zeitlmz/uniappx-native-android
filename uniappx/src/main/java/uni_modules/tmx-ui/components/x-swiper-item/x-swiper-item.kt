...
open class GenUniModulesTmxUiComponentsXSwiperItemXSwiperItem : VueComponent {
    ...
    override fun `$render`(): Any? {
        ...
        return createElementVNode("view", utsMapOf("class" to "xSwiperItem", "style" to normalizeStyle(utsMapOf("height" to _ctx._itemheight, "borderRadius" to _ctx._round, "width" to (_ctx.containerSize.width + "px"), "transform" to ("translate(" + _ctx._styleOpts.left + "," + _ctx._styleOpts.top + ")"), "zIndex" to if (_ctx.isActive) {
            "8"
        } else {
            "1"
        }
        , "position" to if (_ctx.xSwiperModel == "card") {
            ...
            createElementVNode("view", utsMapOf("class" to "xSwiperItembox", "style" to normalizeStyle(utsMapOf("width" to _ctx._styleOpts.width, "borderRadius" to _ctx._round))), utsArrayOf(
                createElementVNode("view", utsMapOf("onClick" to _ctx.onClick, "class" to normalizeClass(utsArrayOf(
                    utsArrayOf(
                    ...
                    "xSwiperItemWrap"
                )), "style" to normalizeStyle(utsMapOf("borderRadius" to _ctx._round))), utsArrayOf(
    ...
    override fun data(): Map<String, Any?> {
        return utsMapOf("id" to ("xSwiperItem-" + getUid()) as String, "containerSize" to SIZE(width = 0, height = 0), "list" to utsArrayOf<String>(), "currentId" to "", "currentId_next" to "", "currentId_prev" to "", "moveShowCurrentIdByPrev" to "", "moveShowCurrentIdByNext" to "", "isActive" to computed<Boolean>(fun(): Boolean {
    ...
    open fun gen_pushDataToParent_fn() {
        var parent: XSwiperComponentPublicInstance? = null
        try {
            parent = this.`$parent` as XSwiperComponentPublicInstance?
        }
         catch (_e: Throwable) {
            console.error("x-swiper-item：本组件必须放置在x-swiper中的直接子节点，不可单独或者嵌套使用。")
        }
        if (parent == null) {
            return
        }
    ...
    companion object {
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return utsMapOf("xSwiperItem" to padStyleMapOf(utsMapOf("display" to "flex", "flexDirection" to "row", "transitionDuration" to "350ms", "transitionProperty" to "opacity,transform,left,margin,top", "transitionTimingFunction" to "cubic-bezier(0.42,0.38,0.15,0.93)")), "xSwiperItemAlign" to padStyleMapOf(utsMapOf("justifyContent" to "flex-end")), "xSwiperItembox" to padStyleMapOf(utsMapOf("display" to "flex", "flexDirection" to "row", "alignItems" to "center", "justifyContent" to "center", "height" to "100%", "transitionDuration" to "600ms", "transitionProperty" to "width", "transitionTimingFunction" to "cubic-bezier(0.42,0.38,0.15,0.93)", "overflow" to "hidden")), "xSwiperItemWrapSaniOn" to padStyleMapOf(utsMapOf("transform" to "scale(1)", "opacity" to 1)), "xSwiperItemWrapSaniOff" to padStyleMapOf(utsMapOf("transform" to "scale(0)", "opacity" to 0)), "xSwiperItemOn" to padStyleMapOf(utsMapOf("zIndex" to 6)), "xSwiperItemWrapSaniDiffOff_left" to padStyleMapOf(utsMapOf("zIndex" to 2)), "xSwiperItemWrapSaniDiffOff_right" to padStyleMapOf(utsMapOf("zIndex" to 2)), "xSwiperItemWrap" to padStyleMapOf(utsMapOf("flex" to 1, "height" to "100%", "width" to "100%", "transitionDuration" to "600ms", "transitionProperty" to "opacity,transform,left,margin", "transitionTimingFunction" to "cubic-bezier(0.42,0.38,0.15,0.93)")), "@TRANSITION" to utsMapOf("xSwiperItem" to utsMapOf("duration" to "350ms", "property" to "opacity,transform,left,margin,top", "timingFunction" to "cubic-bezier(0.42,0.38,0.15,0.93)"), "xSwiperItembox" to utsMapOf("duration" to "600ms", "property" to "width", "timingFunction" to "cubic-bezier(0.42,0.38,0.15,0.93)"), "xSwiperItemWrap" to utsMapOf("duration" to "600ms", "property" to "opacity,transform,left,margin", "timingFunction" to "cubic-bezier(0.42,0.38,0.15,0.93)")))
            }
