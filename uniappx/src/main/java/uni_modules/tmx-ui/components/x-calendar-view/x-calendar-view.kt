...
open class GenUniModulesTmxUiComponentsXCalendarViewXCalendarView : VueComponent {
    ...
    companion object {
        ...
        var components: Map<String, CreateVueComponent> = utsMapOf("calendar" to GenUniModulesTmxUiComponentsXCalendarViewCalendarClass)
    }
}
