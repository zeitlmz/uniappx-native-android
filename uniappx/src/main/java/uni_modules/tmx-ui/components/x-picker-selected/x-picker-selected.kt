...
open class GenUniModulesTmxUiComponentsXPickerSelectedXPickerSelected : VueComponent {
            ...
            , "show-close" to _ctx.showClose, "size" to "80%"), utsMapOf("default" to withSlotCtx(fun(): UTSArray<Any> {
                return utsArrayOf(
                    if (isTrue(_ctx.showSearch)) {
                        createElementVNode("view", utsMapOf("key" to 0, "class" to "xPickerSlectedIwrap"), utsArrayOf(
                    ...
                    createElementVNode("view", utsMapOf("class" to "xPickerSlectedWrap"), utsArrayOf(
                        ...
                        if (isTrue(_ctx._list.length > 0 && _ctx.yanchiDuration)) {
                            createVNode(_component_x_pull_refresh, utsMapOf("key" to 1, "disabled-bottom" to _ctx._disabledBottom, "disabled-pull" to _ctx._disabledPull, "onRefresh" to _ctx.loadRefres, "onBottomRefresh" to _ctx.bottomLoadRefres, "modelValue" to _ctx.isRefresh, "onUpdate:modelValue" to fun(`$event`: Boolean){
                        ...
                        if (isTrue(_ctx._list.length > 0 && _ctx.yanchiDuration)) {
                            createElementVNode("view", utsMapOf("key" to 2, "class" to "xPickerSlectedFooter"), utsArrayOf(
                                ...
                                createElementVNode("view", utsMapOf("class" to "xPickerSlectedFooterBtn"), utsArrayOf(
                                    createVNode(_component_x_text, utsMapOf("class" to "xPickerSlectedFooterBtnText", "onClick" to _ctx.clearAll, "color" to "#666", "font-size" to "14"), utsMapOf("default" to withSlotCtx(fun(): UTSArray<Any> {
                                        return utsArrayOf(
                                            " 清空选择 "
                                        )
                                    }), "_" to 1), 8, utsArrayOf(
                                    ...
                                    if (isTrue(_ctx.multiple)) {
                                        createVNode(_component_x_text, utsMapOf("key" to 0, "style" to normalizeStyle(utsMapOf("margin-left" to "24px")), "class" to "xPickerSlectedFooterBtnText", "onClick" to _ctx.selectedAll, "color" to _ctx._color, "font-size" to "14"), utsMapOf("default" to withSlotCtx(fun(): UTSArray<Any> {
                                            return utsArrayOf(
                                                " 选择所有 "
                                            )
                                        }), "_" to 1), 8, utsArrayOf(
    ...
    companion object {
        ...
        ), "localSearch" to utsMapOf("type" to "Boolean", "default" to true), "multiple" to utsMapOf("type" to "Boolean", "default" to true), "lazyContent" to utsMapOf("type" to "Boolean", "default" to false), "lazyDuration" to utsMapOf("type" to "Number", "default" to 100), "itemHeight" to utsMapOf("type" to "String", "default" to "50"), "zIndex" to utsMapOf("type" to "Number", "default" to 1100), "showClose" to utsMapOf("type" to "Boolean", "default" to false), "refresh" to utsMapOf("type" to "Boolean", "default" to false), "bottomRefresh" to utsMapOf("type" to "Boolean", "default" to false), "disabledPull" to utsMapOf("type" to "Boolean", "default" to true), "disabledBottom" to utsMapOf("type" to "Boolean", "default" to true), "disabled" to utsMapOf("type" to "Boolean", "default" to false), "showSearch" to utsMapOf("type" to "Boolean", "default" to false)))
