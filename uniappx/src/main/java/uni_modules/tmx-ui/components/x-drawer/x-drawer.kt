                    ...
                    createElementVNode("view", utsMapOf("onTransitionend" to _ctx.onEnd, "onClick" to withModifiers(fun(){}, utsArrayOf(
                        ...
                        if (isTrue(_ctx._showClose)) {
                            createElementVNode("view", utsMapOf("key" to 0, "class" to "xDrawerXclose"), utsArrayOf(
                                createVNode(_component_x_icon, utsMapOf("onClick" to _ctx.cancelEvt, "color" to "#dcdcdc", "font-size" to "24", "name" to _ctx._closeIcon), null, 8, utsArrayOf(
                                    "onClick",
                                    "name"
                                ))
                            ))
                                    ...
                                    return utsArrayOf(
                                        createElementVNode("view", utsMapOf("style" to normalizeStyle(utsMapOf("flex-direction" to "row", "align-items" to "center", "justify-content" to "center", "display" to "flex"))), utsArrayOf(
                                            if (isTrue(_ctx._showCancel)) {
                                                createVNode(_component_x_button, utsMapOf("key" to 0, "color" to _ctx._btnColor, "onClick" to _ctx.cancelEvt, "skin" to "thin", "width" to "0px", "block" to true, "style" to normalizeStyle(utsMapOf("margin-right" to "16rpx", "flex" to "1"))), utsMapOf("default" to withSlotCtx(fun(): UTSArray<Any> {
                                                    return utsArrayOf(
                                            ...
                                            createVNode(_component_x_button, utsMapOf("color" to _ctx._btnColor, "onClick" to _ctx.confirmEvt, "width" to "0px", "disabled" to _ctx._disabledConfirm, "block" to true, "style" to normalizeStyle(utsMapOf("flex" to "1"))), utsMapOf("default" to withSlotCtx(fun(): UTSArray<Any> {
                                                return utsArrayOf(
