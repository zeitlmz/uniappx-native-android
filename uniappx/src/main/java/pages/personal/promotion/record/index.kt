...
open class GenPagesPersonalPromotionRecordIndex : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesPersonalPromotionRecordIndex) -> Any? = fun(__props): Any? {
            ...
            val detailList = ref(_uA<ITEM_INFO>())
            ...
            return fun(): Any? {
                ...
                return _cV(_component_mc_base_container, _uM("showStatusBarPlaceholder" to false, "scroll" to true, "show-navbar" to true, "navbarIsPlace" to false, "static-transparent" to false, "title" to "推广记录"), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                    return _uA(
                            ...
                            _cE("view", _uM("class" to "order-list"), _uA(
                                _cV(_component_template, null, _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                    return _uA(
                                        ...
                                        , "onRefresh" to topLoad, "onBottomRefresh" to bottomLoad, "height" to ((unref(screenHeight) - unref(globalData).safeAreaBottom - unref(statusBarHeight) - 100) + "px")), _uM("default" to withSlotCtx(fun(): UTSArray<Any> {
                                            return _uA(
                                                _cE(Fragment, null, RenderHelpers.renderList(unref(detailList), fun(item, index, __index, _cached): Any {
                                                    return _cE("view", _uM("class" to "order-item", "style" to _nS("margin-bottom: 20rpx;height:70px;width: " + (unref(screenWidth) - 30) + "; \n							background-color: #ffffff; border-radius: 20rpx; padding: 20rpx;"), "key" to index), _uA(
                                                        _cE("view", _uM("style" to _nS(_uM("flex-direction" to "column", "justify-content" to "space-between"))), _uA(
                                                            _cE("text", _uM("style" to _nS(_uM("font-family" to "PingFang SC", "font-weight" to "bold", "font-size" to "30rpx", "color" to "#000000"))), _tD(item.maskedPhone), 5),
                                                            _cE("text", _uM("style" to _nS(_uM("font-family" to "PingFang SC", "font-weight" to "bold", "font-size" to "26rpx", "color" to "#BFBFBF", "margin-top" to "5rpx"))), _tD(item.updateTime), 5)
                                                        ), 4),
                                                        _cE("text", _uM("style" to _nS(_uM("font-family" to "PingFang SC", "font-weight" to "bold", "font-size" to "34rpx", "color" to "#2D9E62"))), " 成功 ", 4)
                                                    ), 4)
                                                }
                                                ), 128),
        ...
        val styles0: Map<String, Map<String, Map<String, Any>>>
            get() {
                return _uM("container" to _pS(_uM("width" to "100%", "position" to "relative", "paddingTop" to 0, "paddingRight" to 15, "paddingBottom" to 0, "paddingLeft" to 15, "marginTop" to 20, "height" to "100%")), "home-bg" to _pS(_uM("position" to "absolute", "top" to 0, "left" to 0, "width" to "100%", "zIndex" to -1, "height" to "100%")), "top-bg" to _uM(".home-bg " to _uM("height" to "100%", "width" to "100%", "backgroundImage" to "linear-gradient(to bottom, #CAD7F2, #FFFFFF)")), "order-list" to _pS(_uM("marginTop" to 50, "height" to "100%")), "order-item" to _uM(".order-list " to _uM("display" to "flex", "flexDirection" to "row", "justifyContent" to "space-between", "alignItems" to "center")), "order-route" to _uM(".order-list .order-item " to _uM("display" to "flex", "alignItems" to "center")), "price" to _uM(".order-list .order-item " to _uM("fontSize" to 23, "color" to "#FF3B30", "fontWeight" to "bold", "marginLeft" to "auto")))
            }
