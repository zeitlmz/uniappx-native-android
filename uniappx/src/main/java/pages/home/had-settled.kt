        ...
        var setup: (__props: GenPagesHomeHadSettled, _arg1: SetupContext) -> Any? = fun(__props, ref1): Any? {
            ...
            return fun(): Any? {
                ...
                return createElementVNode(Fragment, null, utsArrayOf(
                    ...
                    , "show-scrollbar" to false), utsArrayOf(
                        ...
                        createElementVNode("view", utsMapOf("class" to "header"), utsArrayOf(
                            ...
                            createVNode(_component_mc_active_animation, utsMapOf("onClick" to toPersonPage, "class" to "avatar-box"), utsMapOf("default" to withSlotCtx(fun(): UTSArray<Any> {
                                return utsArrayOf(
                                    createElementVNode("image", utsMapOf("class" to "avatar", "src" to unref(headImg)), null, 8, utsArrayOf(
                                        "src"
                                    ))
                                )
                            }
                            ...
                            createElementVNode("swiper-item", utsMapOf("style" to normalizeStyle(utsMapOf("height" to "auto")), "key" to "0"), utsArrayOf(
                                createElementVNode("view", utsMapOf("class" to "container"), utsArrayOf(
                                    ...
                                    createElementVNode("view", utsMapOf("class" to "order-box"), utsArrayOf(
                                        createElementVNode("swiper", utsMapOf("current" to unref(acitveOrderType), "onChange" to fun(e: UniSwiperChangeEvent){
                                            return onOrderTypeChange(e.detail.current)
                                        }
                                        , "disable-touch" to false, "rebound" to ""), utsArrayOf(
                    ...
                    , "bgColor" to "#ECF1F8", "cancel-text" to "拒绝", "overlay-click" to false, "onCancel" to locationAgreeCancel, "confirm-text" to "同意", "onConfirm" to locationAgreeConfirm, "show-title" to false, "height" to "600rpx"), utsMapOf("default" to withSlotCtx(fun(): UTSArray<Any> {
                        return utsArrayOf(
                            ...
                            createElementVNode("view", utsMapOf("class" to "desc"), utsArrayOf(
                                ...
                                createElementVNode("text", utsMapOf("class" to "text-row blod"), "本APP提供了撤回系统权限的功能，具体路径:个人中心(登录后点击右上角)-设置-账户与安全-权限管理。")
                            ))
                        )
                    }
                    ), "_" to 1), 8, utsArrayOf(
